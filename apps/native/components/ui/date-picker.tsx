...
export function DatePicker(props: DatePickerProps) {
  ...
  const renderMonthYearHeader = () => (
    ...
    >
      ...
      >
        ...
        >
          <Text style={{ marginRight: 4 }} variant="subtitle">
    ...
    <View>
      ...
      >
        {DAYS.map((day) => (
          ...
          >
            <Text style={{ fontSize: 12, fontWeight: "600" }} variant="caption">
              {day}
            </Text>
          </View>
        ))}
      ...
      {mode === "range" && (
        ...
        >
          <Text style={{ flex: 1 }} variant="subtitle">
            {tempRange.startDate
          ...
          <Text style={{ flex: 1, textAlign: "right" }} variant="subtitle">
            {tempRange.endDate
  ...
  const handleOpenPicker = () => {
    const nextCurrentDate = getCurrentDate();
    setCurrentDate(nextCurrentDate);
    if (mode === "range") {
      const nextRange = isDateRange(value)
        ? value
        : { startDate: null, endDate: null };
      ...
      >
        <View style={{ flex: 1 }}>
          ...
          >
            ...
            >
              <Button onPress={resetToToday} variant="outline">
                Today
              </Button>
