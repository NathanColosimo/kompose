...
export const ToolContent = ({ className, ...props }: ToolContentProps) => (
  <CollapsibleContent
    className={cn(
      "data-[state=closed]:fade-out-0 data-[state=closed]:slide-out-to-top-2 data-[state=open]:slide-in-from-top-2 space-y-2 px-2 pb-2 text-popover-foreground outline-none data-[state=closed]:animate-out data-[state=open]:animate-in",
      className
    )}
    {...props}
  />
...
export const ToolInput = ({ className, input, ...props }: ToolInputProps) => (
  <div className={cn("space-y-1 overflow-hidden", className)} {...props}>
    ...
    <div className="rounded bg-muted/50 text-[11px] [&_code]:text-[11px] [&_pre]:p-2 [&_pre]:text-[11px]">
...
export const ToolOutput = ({
  ...
  return (
    <div className={cn("space-y-1", className)} {...props}>
      ...
      <div
        className={cn(
          "overflow-x-auto rounded text-[11px] [&_code]:text-[11px] [&_pre]:p-2 [&_pre]:text-[11px] [&_table]:w-full",
          errorText
